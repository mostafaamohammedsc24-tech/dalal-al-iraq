    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-50 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">مرحباً بك في شبكة دلال العراق</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-center text-gray-400 text-sm mt-5">
            {t("auth.noAccount")}{" "}
            <Link href="/register" className="text-orange-500 font-medium hover:underline">{t("auth.register")}</Link>
          </p>
        </div>

        <p className="text-center text-gray-400 text-xs mt-6">
          مكتب دلالية أو محامٍ معتمد؟{" "}
          <Link href="/office/login" className="text-orange-500 font-medium hover:underline">دخول المكاتب</Link>
          {" · "}
          <Link href="/lawyer/login" className="text-orange-500 font-medium hover:underline">دخول المحامين</Link>
        </p>
      </div>
    </div>
  );
